...
public class chats extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference().child("Classroom").child(getIntent().getStringExtra("classroom"))
                .addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                final String recieverid = dataSnapshot.child("ownerid").getValue(String.class);

                readMessages(firebaseUser.getUid(), recieverid);
                ...
                btn_sendmessage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(!msg.equals("")){
                            sendMessage(firebaseUser.getUid(), recieverid, msg);
...
//                            Toast.makeText(chats.this, "You can't send empty message", Toast.LENGTH_LONG).show();
    ...
    private void setToolbarimg() {
        FirebaseDatabase.getInstance().getReference().child("Classroom").child(getIntent().getStringExtra("classroom")).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String url = dataSnapshot.child("ownerpic").getValue(String.class);
    ...
    private void setTile(){
        String title = getIntent().getStringExtra("classroom");
        FirebaseDatabase.getInstance().getReference().child("Classroom").child(title)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        String classname = dataSnapshot.child("ownername").getValue(String.class);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds : dataSnapshot.getChildren()){
                    ...
                    madapter_chatbubbles = new adapter_chatbubbles(chats.this, mref_chats);
